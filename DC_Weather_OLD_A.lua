...
if camp.weather.zone == nil then
	...
	debugTxt = debugTxt .. string.format("DcW D01_casA r=%d > probaPhight=%.1f | ", r, (100 - probaPhight * 0.7) ) .."\n"
	debugTxt = debugTxt .. string.format("DcW D01_casB r=%d > probaPhight=%.1f | ", r, (100 - probaPhight) ) .."\n"
	debugTxt = debugTxt .. string.format("DcW D01_casC else" ) .."\n"
