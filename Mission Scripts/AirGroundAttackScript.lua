		...
		for w = 1, #wingman do																	--iterate through wingmen
			...
			if PopAlt and PopAlt > 0 then														--attack profile has a pop-up element
				...
				if camp.debug then
					...
					-- env.info("debug AirGroundAttackTask ".."Offset Angle: " .. OffsetAngle)
					-- env.info("debug AirGroundAttackTask ".."Climb Angle: " .. ClimbAngle)
					-- env.info("debug AirGroundAttackTask ".."Roll-In Angle: " .. RollInAngle)
					-- env.info("debug AirGroundAttackTask ".."Offset Turn Radius: " .. TurnRadius)
					-- env.info("debug AirGroundAttackTask ".."Offset Turn To Corner Distance: " .. d_OffsetTurnStart_OffsetTurnCorner)
					-- env.info("debug AirGroundAttackTask ".."Pop-Up Distance: " .. PopDist)
					-- env.info("debug AirGroundAttackTask ".."Climb Distance: " .. ClimbGroundDist)
					-- env.info("debug AirGroundAttackTask ".."Dive Distance: " .. AttackDist)
